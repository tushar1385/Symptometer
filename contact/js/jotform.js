...
//                        p.$jot('.jt-content, .jt-title').css('width', 'auto');
   ...
   */
    ...
    initTestEnvForBranding21: function() {
        ...
        var isPreview = getQuerystring('preview');
        isPreview = isPreview ? isPreview === 'true' : false;
        var docBody = window.FORM_MODE === 'cardform' ? document.querySelector('.JotFormCardBuilder.cf-minimal') : document.querySelector('.JotFormBuilder');
        if (window.location.href.indexOf('branding21') > -1 || (isPreview && docBody && docBody.className.indexOf('branding21') > -1)){
